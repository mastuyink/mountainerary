    ...
    <head>
      ...
      <title>Voucher Mountainerary</title>
      <style type="text/css">
      body {
...
td[class="spechide"] 
  ...
  <tbody>
    <tr>
      <td bgcolor="#EEEEEE"><table width="600" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#ffffff" class="MainContainer">
  <tbody>
    <tr>
                      ...
                      <tbody>
                        <tr>
                          <td valign="top" align="center" class="specbundle">
                            <img class="banner" src="https://mountainerary.com/img/logo.png">
                          </td>
                        </tr>
                      </tbody>
                    </table>
        ...
        <div class="movableContent" style="border: 0px; padding-top: 0px; position: relative;">
        	<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                          ...
                          <tr>
                            <td align='left'>
                              <div class="contentEditableContainer contentTextEditable">
                                <div class="contentEditable" align='justify'>
                                  <p>
                                    Warmest greeting from Mountainerary.com
                                    <br><br>
                                    <p>
                                      Thank you for choosing Mountainerary.com as your trip planner. Your trip reservation has been confirmed as following details:
                                    </p>
                                    <br>
                                    <br>
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="text-align: left;color: #999999;font-size: 14px;font-weight: normal;line-height: 19px;">
                                      <tbody>
                                        <tr>
                                          <td class="trip-detail">Travelers name</td>
                                          <td>: </td>
                                          <td class="trip-detail"> <?= $modelBooking->name ?></td>
                                        </tr>
                                        <tr>
                                          <td class="trip-detail">Phone/Whatsapp</td>
                                          <td>: </td>
                                          <td class="trip-detail"> <?= $modelBooking->phone ?></td>
                                        </tr>
                                        <tr>
                                          <td class="trip-detail">Total travelers</td>
                                          <td>: </td>
                                          <td class="trip-detail"> <?= count($modelBooking->allPassengers) ?> Pax</td>
                                        </tr>
                                        <tr>
                                          <td class="trip-detail">Trip</td>
                                          <td>: </td>
                                          <td class="trip-detail"> <?= $modelBooking->idTrip->name ?></td>
                                        </tr>
                                        <tr>
                                          <td class="trip-detail">Date of trip</td>
                                          <td>: </td>
                                          <td class="trip-detail"> <?= date('D, d-M-Y',strtotime($modelBooking->trip_date)) ?></td>
                                        </tr>
                                        <tr>
                                          <td class="trip-detail">Pick up location</td>
                                          <td>: </td>
                                          <td class="trip-detail">
                                            <?php
                                            $shuttles = $modelBooking->shuttles;
                                            if (isset($shuttles[0]->type) && $shuttles[0]->type == true) {
                                              echo $shuttles[0]->idArea->area.'<br>'.$shuttles[0]->description;
                                            }else{
                                              echo "-";
                                            }
                                             ?>
                                        ...
                                        <tr>
                                          <td class="trip-detail">Drop off location</td>
                                          <td>: </td>
                                          <td class="trip-detail">
                                            <?php
                                              foreach ($shuttles as $key => $value) {
                                                if ($value->type == false) {
                                                  echo $value->idArea->area.' <br>'.$value->description;
                                                }
                                              }
                                             ?>
                                          </td>
                                        ...
                                        <tr>
                                          <td class="trip-detail">Payment method</td>
                                          <td>: </td>
                                          <td class="trip-detail"> <?= $modelBooking->idPaymentMethod->method.'<br>'.$modelBooking->id_currency.' '.number_format($modelBooking->amount,0) ?></td>
                                        </tr>
                                      </tbody>
                                    </table>
                                    <br><br>
                                    <p>
                                      <span style="margin-left: 25px;"></span> Please check the confirmation letter and detailed itinerary on the attached files on this email. 
                                      Should you need any further assistance please do not hesitate to contact us through mountainerary@gmail.com or chat us via Whatsapp <a href="https://api.whatsapp.com/send?phone=628123232323232" title="Whatsapp Direct Chat"> +628123232323232. </a>
                                    </p>
      ...
      <td valign="top" class="specbundle"><div class="contentEditableContainer contentTextEditable">
                                      <div class="contentEditable" align='center'>
                                        <p  style='text-align:left;color:#CCCCCC;font-size:12px;font-weight:normal;line-height:20px;'>
                                          <span style='font-weight:bold;'>Mountainerary.com</span>
                                          <br>
                                          Jl. Gersikan VI No. 9,Pacar Keling, Tambaksari, Surabaya, 6013
                                          <br>
                                        </p>
                                      </div>
                                    </div></td>
